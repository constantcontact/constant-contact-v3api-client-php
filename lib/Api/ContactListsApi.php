...
class ContactListsApi
{
     ...
     * @param  string $channel_type Use to return lists by channel type. The default value is &#x60;email&#x60;. (optional)
     * @param  bool $include_sms_membership_count Set to &#x60;true&#x60; to return the total number of SMS members in each list. Only applicable when &#x60;channel_type&#x60; is &#x60;sms&#x60;. Default is &#x60;false&#x60;. (optional)
     ...
     */
    public function getAllLists($limit = 50, $include_count = false, $include_membership_count = null, $name = null, $status = null, $channel_type = null, $include_sms_membership_count = null, string $contentType = self::contentTypes['getAllLists'][0])
    {
        list($response) = $this->getAllListsWithHttpInfo($limit, $include_count, $include_membership_count, $name, $status, $channel_type, $include_sms_membership_count, $contentType);
        return $response;
    }
     ...
     */
    public function getAllListsWithHttpInfo($limit = 50, $include_count = false, $include_membership_count = null, $name = null, $status = null, $channel_type = null, $include_sms_membership_count = null, string $contentType = self::contentTypes['getAllLists'][0])
    {
        $request = $this->getAllListsRequest($limit, $include_count, $include_membership_count, $name, $status, $channel_type, $include_sms_membership_count, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllListsAsync($limit = 50, $include_count = false, $include_membership_count = null, $name = null, $status = null, $channel_type = null, $include_sms_membership_count = null, string $contentType = self::contentTypes['getAllLists'][0])
    {
        return $this->getAllListsAsyncWithHttpInfo($limit, $include_count, $include_membership_count, $name, $status, $channel_type, $include_sms_membership_count, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllListsAsyncWithHttpInfo($limit = 50, $include_count = false, $include_membership_count = null, $name = null, $status = null, $channel_type = null, $include_sms_membership_count = null, string $contentType = self::contentTypes['getAllLists'][0])
    {
        $returnType = '\ConstantContactApi\Client\Model\GetAllLists200Response';
        $request = $this->getAllListsRequest($limit, $include_count, $include_membership_count, $name, $status, $channel_type, $include_sms_membership_count, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllListsRequest($limit = 50, $include_count = false, $include_membership_count = null, $name = null, $status = null, $channel_type = null, $include_sms_membership_count = null, string $contentType = self::contentTypes['getAllLists'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'include_sms_membership_count', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
