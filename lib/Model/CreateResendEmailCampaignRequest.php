...
/**
 * CreateResendEmailCampaignRequest Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateResendEmailCampaignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createResendEmailCampaign_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resend_subject'] === null) {
            $invalidProperties[] = "'resend_subject' can't be null";
        }
     ...
     * Sets resend_subject
     *
     * @param string $resend_subject The subject line used when resending the email campaign activity.
     *
     * @return self
     */
     ...
     * Sets delay_minutes
     *
     * @param int|null $delay_minutes The number of minutes to wait before Constant Contact resends the email campaign activity. There are 1,440 minutes in a day. Valid values includes a minimum of <code>720</code> (12 hours) and a maximum of <code>14,400</code> minutes (10 days). This property is mutually exclusive with <code>delay_days</code>
     *
     * @return self
     */
