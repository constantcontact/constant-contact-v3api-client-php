...
class CreateSegmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSegment_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['segment_criteria'] === null) {
            $invalidProperties[] = "'segment_criteria' can't be null";
        }
        if ((mb_strlen($this->container['segment_criteria']) > 20000)) {
     ...
     * Sets name
     *
     * @param string $name The segment's unique descriptive name.
     *
     * @return self
     */
    ...
    public function setSegmentCriteria($segment_criteria)
    {
        ...
        if ((mb_strlen($segment_criteria) > 20000)) {
            throw new \InvalidArgumentException('invalid length for $segment_criteria when calling CreateSegmentRequest., must be smaller than or equal to 20000.');
        }
