...
/**
 * FileStatusArrayInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class FileStatusArrayInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileStatusArray_inner';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The upload status.
     *
     * @return self
     */
     ...
     * Sets file_id
     *
     * @param int|null $file_id Identifies the file in MyLibrary.
     *
     * @return self
     */
