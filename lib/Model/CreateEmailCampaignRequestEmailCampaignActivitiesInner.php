...
class CreateEmailCampaignRequestEmailCampaignActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['preheader']) && (mb_strlen($this->container['preheader']) > 200)) {
            $invalidProperties[] = "invalid value for 'preheader', the character length must be smaller than or equal to 200.";
        }
    ...
    public function setPreheader($preheader)
    {
        ...
        if ((mb_strlen($preheader) > 200)) {
            throw new \InvalidArgumentException('invalid length for $preheader when calling CreateEmailCampaignRequestEmailCampaignActivitiesInner., must be smaller than or equal to 200.');
        }
