...
/**
 * GetContactById200ResponsePhoneNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetContactById200ResponsePhoneNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContactById_200_response_phone_numbers_inner';
    ...
    */
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling GetContactById200ResponsePhoneNumbersInner., must be smaller than or equal to 25.');
        }
