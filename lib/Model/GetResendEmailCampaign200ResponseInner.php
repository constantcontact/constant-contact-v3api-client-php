...
/**
 * GetResendEmailCampaign200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetResendEmailCampaign200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getResendEmailCampaign_200_response_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('resend_status', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets resend_subject
     *
     * @param string|null $resend_subject The subject line used when resending the email campaign activity.
     *
     * @return self
     */
     ...
     * Sets delay_days
     *
     * @param int|null $delay_days The number of days to wait before Constant Contact resends the email. Valid values include <code>1</code> to <code>10</code> days. This value is only returned in the response results if the resend activity was created with <code>delay_days</code> or the <code>delay_minutes</code> equal to an exact day value.
     *
     * @return self
     */
     ...
     * Sets resend_date
     *
     * @param \DateTime|null $resend_date The system generated date and time (in ISO-8601 format) that the email campaign activity was resent to non-openers (only included in the response results for sent resend activities).
     *
     * @return self
     */
     ...
     *
     * @param string|null $resend_request_id For scheduled or sent resend to non-opener emails, the system generates an ID that identifies the resend to non-openers activity. For draft email campaign resend activities, the system returns <code>DRAFT</code>.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getResendStatus()
    {
        return $this->container['resend_status'];
    }

    /**
     * Sets resend_status
     *
     * @param string|null $resend_status The status of the resend to non-openers campaign activity. The <code>resend_status</code> is only returned in the response results if the campaign activity is either scheduled to be sent or was already sent.
     *
     * @return self
     */
    public function setResendStatus($resend_status)
    {
        if (is_null($resend_status)) {
            throw new \InvalidArgumentException('non-nullable resend_status cannot be null');
        }
        $this->container['resend_status'] = $resend_status;
