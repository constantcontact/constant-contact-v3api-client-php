...
/**
 * ContactDelete Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContactDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactDelete';
    ...
    */
    ...
    public function setContactIds($contact_ids)
    {
        ...
        if ((count($contact_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $contact_ids when calling ContactDelete., number of items must be less than or equal to 500.');
        }
    ...
    public function setListIds($list_ids)
    {
        ...
        if ((count($list_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_ids when calling ContactDelete., number of items must be less than or equal to 50.');
        }
