...
/**
 * CreateSegment201Response Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSegment201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSegment_201_response';
    ...
    */
    ...
    public function setSegmentCriteria($segment_criteria)
    {
        ...
        if ((mb_strlen($segment_criteria) > 20000)) {
            throw new \InvalidArgumentException('invalid length for $segment_criteria when calling CreateSegment201Response., must be smaller than or equal to 20000.');
        }
