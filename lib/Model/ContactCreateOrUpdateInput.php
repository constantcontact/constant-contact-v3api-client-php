 ...
 */
class ContactCreateOrUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactCreateOrUpdateInput';
    ...
    protected static $openAPITypes = [
        ...
        'sms_channel' => '\ConstantContactApi\Client\Model\CreateOrUpdateContactRequestSmsChannel'
    ];
    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling ContactCreateOrUpdateInput., must be smaller than or equal to 50.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ContactCreateOrUpdateInput., must be smaller than or equal to 50.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ContactCreateOrUpdateInput., must be smaller than or equal to 50.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if ((mb_strlen($job_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling ContactCreateOrUpdateInput., must be smaller than or equal to 50.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling ContactCreateOrUpdateInput., must be smaller than or equal to 50.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling ContactCreateOrUpdateInput., must be smaller than or equal to 25.');
        }
    ...
    public function setListMemberships($list_memberships)
    {
        ...
        if ((count($list_memberships) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_memberships when calling ContactCreateOrUpdateInput., number of items must be less than or equal to 50.');
        }
        if ((count($list_memberships) < 1)) {
            throw new \InvalidArgumentException('invalid length for $list_memberships when calling ContactCreateOrUpdateInput., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCustomFields($custom_fields)
    {
        ...
        if ((count($custom_fields) > 50)) {
            throw new \InvalidArgumentException('invalid value for $custom_fields when calling ContactCreateOrUpdateInput., number of items must be less than or equal to 50.');
        }
     ...
     * Gets sms_channel
     *
     * @return \ConstantContactApi\Client\Model\CreateOrUpdateContactRequestSmsChannel|null
     */
     ...
     * Sets sms_channel
     *
     * @param \ConstantContactApi\Client\Model\CreateOrUpdateContactRequestSmsChannel|null $sms_channel sms_channel
     *
     * @return self
     */
