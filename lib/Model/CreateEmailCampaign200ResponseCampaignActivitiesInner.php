...
/**
 * CreateEmailCampaign200ResponseCampaignActivitiesInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEmailCampaign200ResponseCampaignActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEmailCampaign_200_response_campaign_activities_inner';
    ...
    */
     ...
     *
     * @param string|null $campaign_activity_id The ID (UUID) that uniquely identifies a campaign activity.
     *
     * @return self
     */
