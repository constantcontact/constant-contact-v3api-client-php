...
/**
 * CustomFieldInput Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldInput';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 50)) {
            throw new \InvalidArgumentException('invalid length for $label when calling CustomFieldInput., must be smaller than or equal to 50.');
        }
