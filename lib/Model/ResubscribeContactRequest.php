...
/**
 * ResubscribeContactRequest Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResubscribeContactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resubscribeContact_request';
    ...
    */
     ...
     * Sets list_ids
     *
     * @param string[] $list_ids Array of list id values. Constant Contact adds the resubscribed contact to the contact lists you provide in the array.
     *
     * @return self
     */
