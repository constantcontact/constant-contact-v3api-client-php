...
/**
 * GetAllSegments200ResponseSegmentsInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAllSegments200ResponseSegmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllSegments_200_response_segments_inner';
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The system generated date and time that the segment was created (ISO-8601 format).
     *
     * @return self
     */
     ...
     * Sets edited_at
     *
     * @param \DateTime|null $edited_at The system generated date and time that the segment's <code>name</code> or <code>segment_criteria</code> was last updated (ISO-8601 format).
     *
     * @return self
     */
