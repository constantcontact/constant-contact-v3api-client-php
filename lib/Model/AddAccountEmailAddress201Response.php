...
/**
 * AddAccountEmailAddress201Response Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddAccountEmailAddress201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addAccountEmailAddress_201_response';
    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 80)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling AddAccountEmailAddress201Response., must be smaller than or equal to 80.');
        }
    ...
    public function setEmailId($email_id)
    {
        ...
        if (($email_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $email_id when calling AddAccountEmailAddress201Response., must be bigger than or equal to 1.');
        }
