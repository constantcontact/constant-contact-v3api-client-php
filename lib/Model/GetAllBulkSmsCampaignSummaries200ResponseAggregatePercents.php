...
/**
 * GetAllBulkSmsCampaignSummaries200ResponseAggregatePercents Class Doc Comment
 *
 * @category Class
 ...
 */
class GetAllBulkSmsCampaignSummaries200ResponseAggregatePercents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllBulkSmsCampaignSummaries_200_response_aggregate_percents';
    ...
    */
     ...
     * Sets deliver
     *
     * @param float|null $deliver The aggregated SMS delivery rate for all campaigns on the current results page.
     *
     * @return self
     */
     ...
     * Sets click
     *
     * @param float|null $click The aggregated click rate for all campaigns on the current results page.
     *
     * @return self
     */
     ...
     * Sets bounce
     *
     * @param float|null $bounce The aggregated bounce rate for all campaigns on the current results page.
     *
     * @return self
     */
     ...
     * Sets unsubscribe
     *
     * @param float|null $unsubscribe The aggregated unsubscribe (opt-out) rate for all campaigns on the current results page.
     *
     * @return self
     */
