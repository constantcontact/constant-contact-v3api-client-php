...
/**
 * EmailTestSendInput Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailTestSendInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailTestSendInput';
    ...
    */
    ...
    public function setEmailAddresses($email_addresses)
    {
        ...
        if ((count($email_addresses) > 5)) {
            throw new \InvalidArgumentException('invalid value for $email_addresses when calling EmailTestSendInput., number of items must be less than or equal to 5.');
        }
