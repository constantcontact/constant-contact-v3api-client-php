...
/**
 * GetEmailCampaignActivitySchedule200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetEmailCampaignActivitySchedule200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getEmailCampaignActivitySchedule_200_response_inner';
    ...
    */
     ...
     * Sets scheduled_date
     *
     * @param \DateTime|null $scheduled_date The date when Constant Contact will send the email campaign activity to contacts in ISO-8601 format. For example, <code>2022-05-17</code> and <code>2022-05-17T16:37:59.091Z</code> are valid dates.
     *
     * @return self
     */
