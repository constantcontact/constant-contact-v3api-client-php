...
/**
 * GetClicksReport200ResponseTrackingActivitiesInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetClicksReport200ResponseTrackingActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getClicksReport_200_response_tracking_activities_inner';
    ...
    */
     ...
     *
     * @param string $tracking_activity_type The type of report tracking activity that is associated with the specified <code>campaign_activity_id</code>.
     *
     * @return self
     */
     ...
     * Sets email_address
     *
     * @param string $email_address The email address used to send the email campaign activity to a contact.
     *
     * @return self
     */
     ...
     * Sets device_type
     *
     * @param string|null $device_type The type of device that the contact was using when they clicked the URL link for the email campaign activity.
     *
     * @return self
     */
     ...
     * Sets url_id
     *
     * @param string $url_id The ID used to uniquely identify the URL link.
     *
     * @return self
     */
     ...
     * Sets link_url
     *
     * @param string $link_url The text used for the URL link.
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime $created_time The date and time that the contact clicked the specified URL link for the email campaign activity.
     *
     * @return self
     */
     ...
     * Sets deleted_at
     *
     * @param \DateTime|null $deleted_at If applicable, displays the date that the contact was deleted.
     *
     * @return self
     */
