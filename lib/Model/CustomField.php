    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 20)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CustomField., must be smaller than or equal to 20.');
        }
    ...
    public function setChoices($choices)
    {
        ...
        if ((count($choices) > 100)) {
            throw new \InvalidArgumentException('invalid value for $choices when calling CustomField., number of items must be less than or equal to 100.');
        }
