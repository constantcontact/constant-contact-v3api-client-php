...
/**
 * GetEmailOpensReport200ResponseTrackingActivitiesInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetEmailOpensReport200ResponseTrackingActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getEmailOpensReport_200_response_tracking_activities_inner';
    ...
    */
     ...
     *
     * @param string $campaign_activity_id The ID that uniquely identifies an email campaign activity.
     *
     * @return self
     */
     ...
     *
     * @param string $tracking_activity_type The type of tracking activity that is associated with this <code>campaign_activity_id</code> and used for reporting purposes.
     *
     * @return self
     */
     ...
     * Sets device_type
     *
     * @param string|null $device_type The type of device that the contact used to open the email campaign activity.
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime $created_time The date and time that the contact opened the email campaign activity.
     *
     * @return self
     */
