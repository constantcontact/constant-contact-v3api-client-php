...
/**
 * GetBouncesReport200ResponseTrackingActivitiesInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetBouncesReport200ResponseTrackingActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBouncesReport_200_response_tracking_activities_inner';
    ...
    protected static $setters = [
        ...
        'bounce_code' => 'setBounceCode',
        'current_email_address' => 'setCurrentEmailAddress',
    ...
    protected static $getters = [
        ...
        'bounce_code' => 'getBounceCode',
        'current_email_address' => 'getCurrentEmailAddress',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bounce_code', $data ?? [], null);
        $this->setIfExists('current_email_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bounce_code'] === null) {
            $invalidProperties[] = "'bounce_code' can't be null";
        }
     ...
     * Sets contact_id
     *
     * @param string $contact_id The ID that uniquely identifies a contact.
     *
     * @return self
     */
     ...
     *
     * @param string $campaign_activity_id The ID that uniquely identifies the email campaign activity.
     *
     * @return self
     */
     ...
     *
     * @param string $tracking_activity_type The type of email tracking activity, <code>em_bounces</code>, that this report includes.
     *
     * @return self
     */
     ...
     * Sets email_address
     *
     * @param string $email_address The contact's email address that was used when the email campaign activity bounced.
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime $created_time The date and time that the email bounce tracking activity occurred.
     *
     * @return self
     */
     ...
     * Sets deleted_at
     *
     * @param \DateTime|null $deleted_at If applicable, the date when the contact was deleted.
     *
     * @return self
     */
