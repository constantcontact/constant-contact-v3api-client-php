...
/**
 * GetAllEmailCampaigns200ResponseCampaignsInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAllEmailCampaigns200ResponseCampaignsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllEmailCampaigns_200_response_campaigns_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetAllEmailCampaigns200ResponseCampaignsInner., must be smaller than or equal to 80.');
        }
