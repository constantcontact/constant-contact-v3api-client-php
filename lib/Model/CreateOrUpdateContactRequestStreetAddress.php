...
/**
 * CreateOrUpdateContactRequestStreetAddress Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrUpdateContactRequestStreetAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createOrUpdateContact_request_street_address';
    ...
    */
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street when calling CreateOrUpdateContactRequestStreetAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreateOrUpdateContactRequestStreetAddress., must be smaller than or equal to 50.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 50)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CreateOrUpdateContactRequestStreetAddress., must be smaller than or equal to 50.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CreateOrUpdateContactRequestStreetAddress., must be smaller than or equal to 50.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 50)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreateOrUpdateContactRequestStreetAddress., must be smaller than or equal to 50.');
        }
