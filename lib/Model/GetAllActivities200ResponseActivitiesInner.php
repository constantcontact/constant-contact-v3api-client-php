...
/**
 * GetAllActivities200ResponseActivitiesInner Class Doc Comment
 *
 * @category Class
 ...
 */
class GetAllActivities200ResponseActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllActivities_200_response_activities_inner';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\ConstantContactApi\Client\Model\GetAllActivities200ResponseActivitiesInnerStatus',
        '_links' => '\ConstantContactApi\Client\Model\GetAllActivities200ResponseActivitiesInnerLinks'
    ];
    ...
    */
     ...
     * Sets activity_id
     *
     * @param string|null $activity_id Unique ID for the activity.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime|null $started_at Timestamp showing when we began processing the activity request, in ISO-8601 format.
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param \DateTime|null $completed_at Timestamp showing when we completed processing the activity, in ISO-8601 format.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Timestamp showing when we created the activity, in ISO-8601 format.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Timestamp showing when we last updated the activity, in ISO-8601 format.
     *
     * @return self
     */
     ...
     *
     * @param string|null $source_file_name Name of the file used for an add_contacts activity.
     *
     * @return self
     */
     ...
     * Sets percent_done
     *
     * @param int|null $percent_done Shows the percent done for an activity that we are still processing.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $activity_errors Array of messages describing the errors that occurred.
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \ConstantContactApi\Client\Model\GetAllActivities200ResponseActivitiesInnerStatus|null
     */
     ...
     * Sets status
     *
     * @param \ConstantContactApi\Client\Model\GetAllActivities200ResponseActivitiesInnerStatus|null $status status
     *
     * @return self
     */
     ...
     * Gets _links
     *
     * @return \ConstantContactApi\Client\Model\GetAllActivities200ResponseActivitiesInnerLinks|null
     */
     ...
     * Sets _links
     *
     * @param \ConstantContactApi\Client\Model\GetAllActivities200ResponseActivitiesInnerLinks|null $_links _links
     *
     * @return self
     */
