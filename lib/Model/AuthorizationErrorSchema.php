...
/**
 * AuthorizationErrorSchema Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizationErrorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizationErrorSchema';
    ...
    */
     ...
     * Sets error_key
     *
     * @param string|null $error_key Identifies the type of error.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Description of the error.
     *
     * @return self
     */
