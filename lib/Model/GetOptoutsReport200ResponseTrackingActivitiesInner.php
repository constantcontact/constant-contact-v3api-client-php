...
/**
 * GetOptoutsReport200ResponseTrackingActivitiesInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetOptoutsReport200ResponseTrackingActivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOptoutsReport_200_response_tracking_activities_inner';
    ...
    */
     ...
     * Sets email_address
     *
     * @param string $email_address The contact's email address.
     *
     * @return self
     */
     ...
     * Sets opt_out_reason
     *
     * @param string|null $opt_out_reason The opt-out reason, if the contact entered a reason.
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime $created_time The time that the contact chose to opt-out from receiving future email campaign activities.
     *
     * @return self
     */
