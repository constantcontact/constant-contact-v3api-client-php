...
/**
 * GetAccountDetails200Response Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAccountDetails200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAccountDetails_200_response';
    ...
    protected static $attributeMap = [
        ...
        'encoded_partner_id' => 'encoded_partner_id',
    ...
    protected static $setters = [
        ...
        'encoded_partner_id' => 'setEncodedPartnerId',
    ...
    protected static $getters = [
        ...
        'encoded_partner_id' => 'getEncodedPartnerId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('encoded_partner_id', $data ?? [], null);
    ...
    */
    ...
    public function setContactPhone($contact_phone)
    {
        ...
        if ((mb_strlen($contact_phone) > 25)) {
            throw new \InvalidArgumentException('invalid length for $contact_phone when calling GetAccountDetails200Response., must be smaller than or equal to 25.');
        }
    ...
    /**
     * Gets encoded_partner_id
     *
     * @return string|null
     */
    public function getEncodedPartnerId()
    {
        return $this->container['encoded_partner_id'];
    }

    /**
     * Sets encoded_partner_id
     *
     * @param string|null $encoded_partner_id The encoded partner id that identifies which Constant Contact partner provisioned the account.
     *
     * @return self
     */
    public function setEncodedPartnerId($encoded_partner_id)
    {
        if (is_null($encoded_partner_id)) {
            throw new \InvalidArgumentException('non-nullable encoded_partner_id cannot be null');
        }
        $this->container['encoded_partner_id'] = $encoded_partner_id;
