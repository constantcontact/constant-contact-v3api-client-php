...
/**
 * GetContactById200ResponseCustomFieldsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class GetContactById200ResponseCustomFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContactById_200_response_custom_fields_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('choice_ids', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string $custom_field_id The custom field's unique ID
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The custom field value.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling GetContactById200ResponseCustomFieldsInner., must be smaller than or equal to 255.');
        }
    ...
    {
        return $this->container['choice_ids'];
    }

    /**
     * Sets choice_ids
     *
     * @param string[]|null $choice_ids For <code>>multi_select</code> and <code>single_select</code> data types, the ID that uniquely identifies the choice associated with a the custom field.
     *
     * @return self
     */
    public function setChoiceIds($choice_ids)
    {
        if (is_null($choice_ids)) {
            throw new \InvalidArgumentException('non-nullable choice_ids cannot be null');
        }
        $this->container['choice_ids'] = $choice_ids;
