...
class AccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token A JWT bearer access token that can be used to access the public API.
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string|null $token_type The type of token.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Timestamp that the token will expire in seconds after the UNIX epoch.
     *
     * @return self
     */
     ...
     * Sets scope
     *
     * @param string|null $scope Space delimited list of scopes granted to the access token.
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token Contains a token you can use to refresh the bearer access token.
     *
     * @return self
     */
     ...
     * Sets id_token
     *
     * @param string|null $id_token A JWT token that contains information about user authentication.
     *
     * @return self
     */
