<?php
/**
 * GetHashtagGroups200ResponsePage
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetHashtagGroups200ResponsePage Class Doc Comment
 *
 * @category Class
 ...
 */
class GetHashtagGroups200ResponsePage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getHashtagGroups_200_response_page';
    ...
    */
     ...
     * Sets page
     *
     * @param int $page The current 0-based page number.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int $size The page size (the number of results returned in this response).
     *
     * @return self
     */
     ...
     * Sets total_elements
     *
     * @param int $total_elements The total number of results available across all pages.
     *
     * @return self
     */
     ...
     * Sets total_pages
     *
     * @param int $total_pages The total number of pages available based on the current page size.
     *
     * @return self
     */
