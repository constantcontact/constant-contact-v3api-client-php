...
/**
 * CreateOrUpdateContactRequestCustomFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrUpdateContactRequestCustomFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createOrUpdateContact_request_custom_fields_inner';
    ...
    */
     ...
     *
     * @param string|null $custom_field_id The unique ID for the <code>custom_field</code>.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value of the <code>custom_field</code>.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CreateOrUpdateContactRequestCustomFieldsInner., must be smaller than or equal to 255.');
        }
