...
/**
 * UpdateContactRequestPhoneNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateContactRequestPhoneNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateContact_request_phone_numbers_inner';
    ...
    */
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling UpdateContactRequestPhoneNumbersInner., must be smaller than or equal to 25.');
        }
