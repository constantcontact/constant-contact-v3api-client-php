    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UpdateContactRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UpdateContactRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if ((mb_strlen($job_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling UpdateContactRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling UpdateContactRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setAnniversary($anniversary)
    {
        ...
        if ((mb_strlen($anniversary) > 10)) {
            throw new \InvalidArgumentException('invalid length for $anniversary when calling UpdateContactRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomFields($custom_fields)
    {
        ...
        if ((count($custom_fields) > 25)) {
            throw new \InvalidArgumentException('invalid value for $custom_fields when calling UpdateContactRequest., number of items must be less than or equal to 25.');
        }
    ...
    public function setPhoneNumbers($phone_numbers)
    {
        ...
        if ((count($phone_numbers) > 3)) {
            throw new \InvalidArgumentException('invalid value for $phone_numbers when calling UpdateContactRequest., number of items must be less than or equal to 3.');
        }
    ...
    public function setStreetAddresses($street_addresses)
    {
        ...
        if ((count($street_addresses) > 3)) {
            throw new \InvalidArgumentException('invalid value for $street_addresses when calling UpdateContactRequest., number of items must be less than or equal to 3.');
        }
    ...
    public function setListMemberships($list_memberships)
    {
        ...
        if ((count($list_memberships) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_memberships when calling UpdateContactRequest., number of items must be less than or equal to 50.');
        }
    ...
    public function setTaggings($taggings)
    {
        ...
        if ((count($taggings) > 50)) {
            throw new \InvalidArgumentException('invalid value for $taggings when calling UpdateContactRequest., number of items must be less than or equal to 50.');
        }
    ...
    public function setNotes($notes)
    {
        ...
        if ((count($notes) > 150)) {
            throw new \InvalidArgumentException('invalid value for $notes when calling UpdateContactRequest., number of items must be less than or equal to 150.');
        }
