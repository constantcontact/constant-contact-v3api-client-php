...
/**
 * GetEmailCampaignActivityReport200ResponseResultsInnerStats Class Doc Comment
 *
 * @category Class
 ...
 */
class GetEmailCampaignActivityReport200ResponseResultsInnerStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getEmailCampaignActivityReport_200_response_results_inner_stats';
    ...
    protected static $openAPIFormats = [
        ...
        'em_sends' => 'int32',
        'em_abuse' => 'int32',
        'em_bounces_blocked' => 'int32',
        'em_bounces_mailbox_full' => 'int32',
        'em_bounces_nonexistent_address' => 'int32',
        'em_bounces_other' => 'int32',
        'em_bounces_suspended' => 'int32',
        'em_bounces_undeliverable' => 'int32',
        'em_bounces_vacation' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'em_sends' => false,
        'em_abuse' => false,
        'em_bounces_blocked' => false,
        'em_bounces_mailbox_full' => false,
        'em_bounces_nonexistent_address' => false,
        'em_bounces_other' => false,
        'em_bounces_suspended' => false,
        'em_bounces_undeliverable' => false,
        'em_bounces_vacation' => false
    ];
    ...
    protected static $setters = [
        ...
        'em_sends' => 'setEmSends',
        'em_abuse' => 'setEmAbuse',
        'em_bounces_blocked' => 'setEmBouncesBlocked',
        'em_bounces_mailbox_full' => 'setEmBouncesMailboxFull',
        'em_bounces_nonexistent_address' => 'setEmBouncesNonexistentAddress',
        'em_bounces_other' => 'setEmBouncesOther',
        'em_bounces_suspended' => 'setEmBouncesSuspended',
        'em_bounces_undeliverable' => 'setEmBouncesUndeliverable',
        'em_bounces_vacation' => 'setEmBouncesVacation'
    ];
    ...
    protected static $getters = [
        ...
        'em_sends' => 'getEmSends',
        'em_abuse' => 'getEmAbuse',
        'em_bounces_blocked' => 'getEmBouncesBlocked',
        'em_bounces_mailbox_full' => 'getEmBouncesMailboxFull',
        'em_bounces_nonexistent_address' => 'getEmBouncesNonexistentAddress',
        'em_bounces_other' => 'getEmBouncesOther',
        'em_bounces_suspended' => 'getEmBouncesSuspended',
        'em_bounces_undeliverable' => 'getEmBouncesUndeliverable',
        'em_bounces_vacation' => 'getEmBouncesVacation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('em_abuse', $data ?? [], null);
        $this->setIfExists('em_bounces_blocked', $data ?? [], null);
        $this->setIfExists('em_bounces_mailbox_full', $data ?? [], null);
        $this->setIfExists('em_bounces_nonexistent_address', $data ?? [], null);
        $this->setIfExists('em_bounces_other', $data ?? [], null);
        $this->setIfExists('em_bounces_suspended', $data ?? [], null);
        $this->setIfExists('em_bounces_undeliverable', $data ?? [], null);
        $this->setIfExists('em_bounces_vacation', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getEmAbuse()
    {
        return $this->container['em_abuse'];
    }

    /**
     * Sets em_abuse
     *
     * @param int|null $em_abuse Number of abuse (spam) complaints received.
     *
     * @return self
     */
    public function setEmAbuse($em_abuse)
    {
        if (is_null($em_abuse)) {
            throw new \InvalidArgumentException('non-nullable em_abuse cannot be null');
        }
        $this->container['em_abuse'] = $em_abuse;

        return $this;
    }

    /**
     * Gets em_bounces_blocked
     *
     * @return int|null
     */
    public function getEmBouncesBlocked()
    {
        return $this->container['em_bounces_blocked'];
    }

    /**
     * Sets em_bounces_blocked
     *
     * @param int|null $em_bounces_blocked Unique number bounced because as blocked by the receiving system.
     *
     * @return self
     */
    public function setEmBouncesBlocked($em_bounces_blocked)
    {
        if (is_null($em_bounces_blocked)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_blocked cannot be null');
        }
        $this->container['em_bounces_blocked'] = $em_bounces_blocked;

        return $this;
    }

    /**
     * Gets em_bounces_mailbox_full
     *
     * @return int|null
     */
    public function getEmBouncesMailboxFull()
    {
        return $this->container['em_bounces_mailbox_full'];
    }

    /**
     * Sets em_bounces_mailbox_full
     *
     * @param int|null $em_bounces_mailbox_full Unique number that bounced back with a mailbox full message.
     *
     * @return self
     */
    public function setEmBouncesMailboxFull($em_bounces_mailbox_full)
    {
        if (is_null($em_bounces_mailbox_full)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_mailbox_full cannot be null');
        }
        $this->container['em_bounces_mailbox_full'] = $em_bounces_mailbox_full;

        return $this;
    }

    /**
     * Gets em_bounces_nonexistent_address
     *
     * @return int|null
     */
    public function getEmBouncesNonexistentAddress()
    {
        return $this->container['em_bounces_nonexistent_address'];
    }

    /**
     * Sets em_bounces_nonexistent_address
     *
     * @param int|null $em_bounces_nonexistent_address Unique number that bounced as a non-existent address.
     *
     * @return self
     */
    public function setEmBouncesNonexistentAddress($em_bounces_nonexistent_address)
    {
        if (is_null($em_bounces_nonexistent_address)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_nonexistent_address cannot be null');
        }
        $this->container['em_bounces_nonexistent_address'] = $em_bounces_nonexistent_address;

        return $this;
    }

    /**
     * Gets em_bounces_other
     *
     * @return int|null
     */
    public function getEmBouncesOther()
    {
        return $this->container['em_bounces_other'];
    }

    /**
     * Sets em_bounces_other
     *
     * @param int|null $em_bounces_other Unique number that bounced without an identifiable cause.
     *
     * @return self
     */
    public function setEmBouncesOther($em_bounces_other)
    {
        if (is_null($em_bounces_other)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_other cannot be null');
        }
        $this->container['em_bounces_other'] = $em_bounces_other;

        return $this;
    }

    /**
     * Gets em_bounces_suspended
     *
     * @return int|null
     */
    public function getEmBouncesSuspended()
    {
        return $this->container['em_bounces_suspended'];
    }

    /**
     * Sets em_bounces_suspended
     *
     * @param int|null $em_bounces_suspended Unique number that bounced as suspended. Email address bounces as suspended when multiple non-existent bounces have been received for the same address.
     *
     * @return self
     */
    public function setEmBouncesSuspended($em_bounces_suspended)
    {
        if (is_null($em_bounces_suspended)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_suspended cannot be null');
        }
        $this->container['em_bounces_suspended'] = $em_bounces_suspended;

        return $this;
    }

    /**
     * Gets em_bounces_undeliverable
     *
     * @return int|null
     */
    public function getEmBouncesUndeliverable()
    {
        return $this->container['em_bounces_undeliverable'];
    }

    /**
     * Sets em_bounces_undeliverable
     *
     * @param int|null $em_bounces_undeliverable Unique number that bounced as undeliverable.
     *
     * @return self
     */
    public function setEmBouncesUndeliverable($em_bounces_undeliverable)
    {
        if (is_null($em_bounces_undeliverable)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_undeliverable cannot be null');
        }
        $this->container['em_bounces_undeliverable'] = $em_bounces_undeliverable;

        return $this;
    }

    /**
     * Gets em_bounces_vacation
     *
     * @return int|null
     */
    public function getEmBouncesVacation()
    {
        return $this->container['em_bounces_vacation'];
    }

    /**
     * Sets em_bounces_vacation
     *
     * @param int|null $em_bounces_vacation Unique number that bounced back with a vacation or out of office autoreply.
     *
     * @return self
     */
    public function setEmBouncesVacation($em_bounces_vacation)
    {
        if (is_null($em_bounces_vacation)) {
            throw new \InvalidArgumentException('non-nullable em_bounces_vacation cannot be null');
        }
        $this->container['em_bounces_vacation'] = $em_bounces_vacation;
