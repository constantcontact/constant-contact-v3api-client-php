...
/**
 * AccountPhysicalAddress Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountPhysicalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountPhysicalAddress';
    ...
    */
    ...
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) > 80)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling AccountPhysicalAddress., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling AccountPhysicalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        ...
        if ((mb_strlen($address_line2) > 80)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling AccountPhysicalAddress., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($address_line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling AccountPhysicalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine3($address_line3)
    {
        ...
        if ((mb_strlen($address_line3) > 80)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling AccountPhysicalAddress., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($address_line3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling AccountPhysicalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setStateCode($state_code)
    {
        ...
        if ((mb_strlen($state_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling AccountPhysicalAddress., must be smaller than or equal to 2.');
        }
