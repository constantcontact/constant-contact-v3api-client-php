...
/**
 * GetTag200Response Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTag200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTag_200_response';
    ...
    */
     ...
     * Sets tag_id
     *
     * @param string|null $tag_id The ID that uniquely identifies a tag (UUID format)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The unique tag name.
     *
     * @return self
     */
     ...
     * Sets contacts_count
     *
     * @param int|null $contacts_count The total number of contacts who are assigned this tag.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The system generated date and time when the tag was created (ISO-8601 format).
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The system generated date and time when the tag was last updated (ISO-8601 format).
     *
     * @return self
     */
     ...
     * Sets tag_source
     *
     * @param string|null $tag_source The source used to tag contacts.
     *
     * @return self
     */
