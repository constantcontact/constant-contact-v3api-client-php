...
/**
 * ActivityDeleteListResponse Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivityDeleteListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivityDeleteListResponse';
    ...
    protected static $openAPITypes = [
        ...
        '_links' => '\ConstantContactApi\Client\Model\CreateListDeleteActivity201ResponseLinks'
    ];
    ...
    */
     ...
     * Sets activity_id
     *
     * @param string|null $activity_id Unique ID for the delete list batch job.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Date and time that the request was received, in ISO-8601 format.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Date and time that the request status was updated, in ISO-8601 format.
     *
     * @return self
     */
     ...
     * Sets percent_done
     *
     * @param int|null $percent_done Job completion percentage
     *
     * @return self
     */
     ...
     * Gets _links
     *
     * @return \ConstantContactApi\Client\Model\CreateListDeleteActivity201ResponseLinks|null
     */
     ...
     * Sets _links
     *
     * @param \ConstantContactApi\Client\Model\CreateListDeleteActivity201ResponseLinks|null $_links _links
     *
     * @return self
     */
