...
/**
 * CreateEmailCampaign200Response Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEmailCampaign200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEmailCampaign_200_response';
    ...
    protected static $openAPITypes = [
        'campaign_activities' => '\ConstantContactApi\Client\Model\CreateEmailCampaign200ResponseCampaignActivitiesInner[]',
        'campaign_id' => 'string',
        'created_at' => '\DateTime',
    ...
    */
     ...
     *
     * @return \ConstantContactApi\Client\Model\CreateEmailCampaign200ResponseCampaignActivitiesInner[]|null
     */
     ...
     *
     * @param \ConstantContactApi\Client\Model\CreateEmailCampaign200ResponseCampaignActivitiesInner[]|null $campaign_activities Lists the role and unique activity ID of each campaign activity that is associated with an Email Campaign.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateEmailCampaign200Response., must be smaller than or equal to 80.');
        }
