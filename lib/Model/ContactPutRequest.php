 ...
 */
class ContactPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactPutRequest';
    ...
    protected static $openAPITypes = [
        'email_address' => '\ConstantContactApi\Client\Model\UpdateContactRequestEmailAddress',
        'first_name' => 'string',
        'last_name' => 'string',
        'job_title' => 'string',
        'company_name' => 'string',
        ...
        'phone_numbers' => '\ConstantContactApi\Client\Model\UpdateContactRequestPhoneNumbersInner[]',
        'street_addresses' => '\ConstantContactApi\Client\Model\UpdateContactRequestStreetAddressesInner[]',
        'list_memberships' => 'string[]',
        'taggings' => 'string[]',
        'notes' => '\ConstantContactApi\Client\Model\GetContactById200ResponseNotesInner[]',
        'sms_channel' => '\ConstantContactApi\Client\Model\UpdateContactRequestSmsChannel'
    ];
    ...
    */
     ...
     * Gets email_address
     *
     * @return \ConstantContactApi\Client\Model\UpdateContactRequestEmailAddress|null
     */
     ...
     * Sets email_address
     *
     * @param \ConstantContactApi\Client\Model\UpdateContactRequestEmailAddress|null $email_address email_address
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The contact's first name
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ContactPutRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name The contact's last name
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ContactPutRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets job_title
     *
     * @param string|null $job_title The contact's job title
     *
     * @return self
     */
    public function setJobTitle($job_title)
    {
        ...
        if ((mb_strlen($job_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling ContactPutRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets company_name
     *
     * @param string|null $company_name Name of the company the contact works for.
     *
     * @return self
     */
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling ContactPutRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets birthday_month
     *
     * @param int|null $birthday_month Accepts values from 1-12; must be used with <code>birthday_day</code>
     *
     * @return self
     */
     ...
     * Sets birthday_day
     *
     * @param int|null $birthday_day Accepts values from 1-31; must be used with <code>birthday_month</code>
     *
     * @return self
     */
     ...
     * Sets anniversary
     *
     * @param string|null $anniversary The anniversary date; Accepted formats are MM/DD/YYYY, M/D/YYYY, YYYY/MM/DD, YYYY/M/D, YYYY-MM-DD, YYYY-M-D, MM-DD-YYYY, M-D-YYYY
     *
     * @return self
     */
    public function setAnniversary($anniversary)
    {
        ...
        if ((mb_strlen($anniversary) > 10)) {
            throw new \InvalidArgumentException('invalid length for $anniversary when calling ContactPutRequest., must be smaller than or equal to 10.');
        }
     ...
     * Sets update_source
     *
     * @param string $update_source Identifies who last updated the contact; valid values are <code>Contact</code> or <code>Account</code>.
     *
     * @return self
     */
    ...
    public function setCustomFields($custom_fields)
    {
        ...
        if ((count($custom_fields) > 25)) {
            throw new \InvalidArgumentException('invalid value for $custom_fields when calling ContactPutRequest., number of items must be less than or equal to 25.');
        }
     ...
     * Gets phone_numbers
     *
     * @return \ConstantContactApi\Client\Model\UpdateContactRequestPhoneNumbersInner[]|null
     */
     ...
     * Sets phone_numbers
     *
     * @param \ConstantContactApi\Client\Model\UpdateContactRequestPhoneNumbersInner[]|null $phone_numbers Array of up to 3 <code>phone_numbers</code> subresources.
     *
     * @return self
     */
    public function setPhoneNumbers($phone_numbers)
    {
        ...
        if ((count($phone_numbers) > 3)) {
            throw new \InvalidArgumentException('invalid value for $phone_numbers when calling ContactPutRequest., number of items must be less than or equal to 3.');
        }
     ...
     *
     * @return \ConstantContactApi\Client\Model\UpdateContactRequestStreetAddressesInner[]|null
     */
     ...
     *
     * @param \ConstantContactApi\Client\Model\UpdateContactRequestStreetAddressesInner[]|null $street_addresses Array of up to 3 <code>street_addresses</code> subresources.
     *
     * @return self
     */
    public function setStreetAddresses($street_addresses)
    {
        ...
        if ((count($street_addresses) > 3)) {
            throw new \InvalidArgumentException('invalid value for $street_addresses when calling ContactPutRequest., number of items must be less than or equal to 3.');
        }
    ...
    public function setListMemberships($list_memberships)
    {
        ...
        if ((count($list_memberships) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_memberships when calling ContactPutRequest., number of items must be less than or equal to 50.');
        }
    ...
    public function setTaggings($taggings)
    {
        ...
        if ((count($taggings) > 50)) {
            throw new \InvalidArgumentException('invalid value for $taggings when calling ContactPutRequest., number of items must be less than or equal to 50.');
        }
    ...
    public function setNotes($notes)
    {
        ...
        if ((count($notes) > 150)) {
            throw new \InvalidArgumentException('invalid value for $notes when calling ContactPutRequest., number of items must be less than or equal to 150.');
        }
     ...
     * Gets sms_channel
     *
     * @return \ConstantContactApi\Client\Model\UpdateContactRequestSmsChannel|null
     */
     ...
     * Sets sms_channel
     *
     * @param \ConstantContactApi\Client\Model\UpdateContactRequestSmsChannel|null $sms_channel sms_channel
     *
     * @return self
     */
