...
/**
 * CreateEmailCampaignRequestEmailCampaignActivitiesInnerPhysicalAddressInFooter Class Doc Comment
 *
 * @category Class
 * @description The physical address for the organization that is sending the email campaign. Constant Contact displays this information to contacts in the email message footer. If you do not include a physical address in the email campaign activity, Constant Contact will use the physical address information saved for the Constant Contact user account.
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateEmailCampaignRequestEmailCampaignActivitiesInnerPhysicalAddressInFooter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEmailCampaign_request_email_campaign_activities_inner_physical_address_in_footer';
