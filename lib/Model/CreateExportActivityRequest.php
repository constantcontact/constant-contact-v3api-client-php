...
/**
 * CreateExportActivityRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateExportActivityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createExportActivity_request';
    ...
    */
    ...
    public function setContactIds($contact_ids)
    {
        ...
        if ((count($contact_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $contact_ids when calling CreateExportActivityRequest., number of items must be less than or equal to 500.');
        }
    ...
    public function setListIds($list_ids)
    {
        ...
        if ((count($list_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_ids when calling CreateExportActivityRequest., number of items must be less than or equal to 50.');
        }
    ...
    public function setTagIds($tag_ids)
    {
        ...
        if ((count($tag_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tag_ids when calling CreateExportActivityRequest., number of items must be less than or equal to 50.');
        }
