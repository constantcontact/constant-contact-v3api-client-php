...
/**
 * CreateContactRequestEmailAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateContactRequestEmailAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createContact_request_email_address';
    ...
    */
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 80)) {
            throw new \InvalidArgumentException('invalid length for $address when calling CreateContactRequestEmailAddress., must be smaller than or equal to 80.');
        }
