...
/**
 * TestSendEmailCampaignActivityRequest Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class TestSendEmailCampaignActivityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'testSendEmailCampaignActivity_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['email_addresses']) > 5)) {
     ...
     *
     * @param string[] $email_addresses The recipients of the test email as an array of email address strings. You can send a test email to up to 5 different email addresses at a time.
     *
     * @return self
     */
    public function setEmailAddresses($email_addresses)
    {
        ...
        if ((count($email_addresses) > 5)) {
            throw new \InvalidArgumentException('invalid value for $email_addresses when calling TestSendEmailCampaignActivityRequest., number of items must be less than or equal to 5.');
        }
     ...
     *
     * @param string|null $personal_message A personal message for the recipients of the test email. Constant Contact displays this message before the email campaign activity content.
     *
     * @return self
     */
    public function setPersonalMessage($personal_message)
    {
        if (is_null($personal_message)) {
            throw new \InvalidArgumentException('non-nullable personal_message cannot be null');
        }
