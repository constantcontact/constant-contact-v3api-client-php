...
class GetCustomField200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'int',
        'choices' => '\ConstantContactApi\Client\Model\GetCustomField200ResponseChoicesInner[]',
        'updated_at' => '\DateTime',
        'created_at' => '\DateTime'
    ];
    ...
    */
     ...
     *
     * @param string|null $custom_field_id The system generated ID that uniquely identifies a <code>custom_field</code>.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The custom field name to display in the UI (free-form text).
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The unique custom field name constructed from the label by replacing blanks with underscores.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The data value type the custom field accepts.
     *
     * @return self
     */
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 20)) {
            throw new \InvalidArgumentException('invalid length for $type when calling GetCustomField200Response., must be smaller than or equal to 20.');
        }
     ...
     * Sets version
     *
     * @param int|null $version For <code>datetime</code> data types, this is the version number associated with the custom field.
     *
     * @return self
     */
     ...
     * Gets choices
     *
     * @return \ConstantContactApi\Client\Model\GetCustomField200ResponseChoicesInner[]|null
     */
    ...
    public function setChoices($choices)
    {
        ...
        if ((count($choices) > 100)) {
            throw new \InvalidArgumentException('invalid value for $choices when calling GetCustomField200Response., number of items must be less than or equal to 100.');
        }
