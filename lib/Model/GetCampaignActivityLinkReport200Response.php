...
/**
 * GetCampaignActivityLinkReport200Response Class Doc Comment
 *
 * @category Class
 * @package  ConstantContactApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetCampaignActivityLinkReport200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCampaignActivityLinkReport_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'link_click_counts' => '\ConstantContactApi\Client\Model\GetCampaignActivityLinkReport200ResponseLinkClickCountsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'link_click_counts' => 'setLinkClickCounts'
    ];
    ...
    protected static $getters = [
        ...
        'link_click_counts' => 'getLinkClickCounts'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('link_click_counts', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \ConstantContactApi\Client\Model\GetCampaignActivityLinkReport200ResponseLinkClickCountsInner[]|null
     */
    public function getLinkClickCounts()
    {
        return $this->container['link_click_counts'];
    }

    /**
     * Sets link_click_counts
     *
     * @param \ConstantContactApi\Client\Model\GetCampaignActivityLinkReport200ResponseLinkClickCountsInner[]|null $link_click_counts An array of objects that contain the contact click count and link metadata for each unique link URL in an email campaign activity. By default, this method combines results for duplicate link URLs.
     *
     * @return self
     */
    public function setLinkClickCounts($link_click_counts)
    {
        if (is_null($link_click_counts)) {
            throw new \InvalidArgumentException('non-nullable link_click_counts cannot be null');
        }
        $this->container['link_click_counts'] = $link_click_counts;
