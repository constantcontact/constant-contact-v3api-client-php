    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 128)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling ContactDto., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($email_address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling ContactDto., must be bigger than or equal to 0.');
        }
    ...
    public function setFromEmailAddress($from_email_address)
    {
        ...
        if ((mb_strlen($from_email_address) > 128)) {
            throw new \InvalidArgumentException('invalid length for $from_email_address when calling ContactDto., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($from_email_address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $from_email_address when calling ContactDto., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContactDto., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContactDto., must be bigger than or equal to 0.');
        }
    ...
    public function setOrganizationName($organization_name)
    {
        ...
        if ((mb_strlen($organization_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organization_name when calling ContactDto., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($organization_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $organization_name when calling ContactDto., must be bigger than or equal to 0.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling ContactDto., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling ContactDto., must be bigger than or equal to 1.');
        }
