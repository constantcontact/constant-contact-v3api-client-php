...
/**
 * GetContactById200ResponseEmailAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class GetContactById200ResponseEmailAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContactById_200_response_email_address';
    ...
    */
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 80)) {
            throw new \InvalidArgumentException('invalid length for $address when calling GetContactById200ResponseEmailAddress., must be smaller than or equal to 80.');
        }
    ...
    public function setOptOutReason($opt_out_reason)
    {
        ...
        if ((mb_strlen($opt_out_reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $opt_out_reason when calling GetContactById200ResponseEmailAddress., must be smaller than or equal to 255.');
        }
