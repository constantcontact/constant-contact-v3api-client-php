...
/**
 * GetContactIdXrefs200ResponseXrefsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class GetContactIdXrefs200ResponseXrefsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContactIdXrefs_200_response_xrefs_inner';
    ...
    */
     ...
     * Sets sequence_id
     *
     * @param string|null $sequence_id The V2 API contact unique identifier
     *
     * @return self
     */
     ...
     * Sets contact_id
     *
     * @param string|null $contact_id The V3 API contact unique identifier
     *
     * @return self
     */
