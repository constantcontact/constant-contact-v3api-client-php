...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cc.email/v3';
     ...
     * @var string
     */
    protected $userAgent = 'ConstantContactApiPhp/1.12.0';
    ...
    {
        $report  = 'PHP SDK (ConstantContactApi\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.222' . PHP_EOL;
