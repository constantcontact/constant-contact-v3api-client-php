...
1. Run `composer require constantcontactpublicapi/constant-contact-v3api-client-php`
2. Run `composer install`

### Manual Installation
1. Run `git clone https://github.com/constantcontact/constant-contact-v3api-client-php.git`
2. Navigate to the project root, then run `composer install`
3. Add `vendor/autoload.php` to your codebase:
```php
<?php
